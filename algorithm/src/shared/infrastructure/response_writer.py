...
class ResponseWriter:
    ...
    def write_json(self, results: ResponseDTO, output_path: Path) -> None:
        """
        ...
        if not isinstance(results, ResponseDTO):
            raise ValidationError(f"Results must be a ResponseDTO object, got {type(results)}")
